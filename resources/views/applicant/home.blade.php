          ...
          <div id="collapse-{{ $job->id }}" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
              <h4> Job description:</h4> {{ $job->description }}
					...
					<div id="collapse-{{ $job->id }}" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
              <h4> Office Location:</h4> {{ $job->location }}, {{ $job->country }}
            </div>
          </div>

					<div id="collapse-{{ $job->id }}" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
              <h4> Salary Range:</h4> {{ $job->salary }}
            </div>
          </div>

					<div id="collapse-{{ $job->id }}" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
              <h4> Application Deadline:</h4> <time datetime="{{ $job->deadline}}">{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $job->deadline)->format('d-M-y') }}</time>
            </div>
          </div>
